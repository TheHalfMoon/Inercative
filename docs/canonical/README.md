...
7. [Harness and Routing](HARNESS_AND_ROUTING.md)
8. [Supabase Platform](SUPABASE_PLATFORM.md)
9. [Failure, Recovery, and Change Safety](FAILURE_RECOVERY_AND_CHANGE_SAFETY.md)
10. [UX and Design](UX_AND_DESIGN.md)
11. [Runtime and Security](RUNTIME_AND_SECURITY.md)
12. [Quality and Review](QUALITY_AND_REVIEW.md)
